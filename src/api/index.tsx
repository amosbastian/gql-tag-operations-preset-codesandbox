...
export type PostsQuery = {
  ...
  posts?: Maybe<{
    __typename?: "PostsPage";
    data?: Maybe<Array<Maybe<{ __typename?: "Post" } & PostFragment>>>;
  }>;
};
...
export type CreatePostMutation = {
  __typename?: "Mutation";
  createPost?: Maybe<{ __typename?: "Post" } & PostFragment>;
};

export const PostFragmentDoc: DocumentNode<PostFragment, unknown> = {
  kind: "Document",
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "PageQueryOptions" }
          }
        }
      ],
      selectionSet: {
